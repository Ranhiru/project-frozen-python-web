FactoryGirl.define do
  ...
  factory :auth_response, class: OmniAuth::AuthHash do
    skip_create
    ...
    transient do
      ...
      locale "en_US"
      verified true
      updated_time { SecureRandom.random_number.seconds.ago }
      token { SecureRandom.urlsafe_base64(100).delete("-_").first(100) }
      expires_at { SecureRandom.random_number.seconds.from_now }
